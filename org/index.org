...
#+HTML_HEAD: <style> a{color:#c6a0f6;} </style>
#+HTML_HEAD: <style> th {background-color: #11111b;color: white;} </style>
#+HTML_HEAD: <style> body{background:#11111b; color:#404040;} </style>
#+HTML_HEAD: <style> #content{background:#11111b;} </style> 

#+HTML_HEAD: <style> blockquote{background-color: #1e1e2e; border-left:5px solid#cba6f7;} </style>

#+HTML_HEAD: <style> #table-of-contents header{color: #11111b;} </style>
#+HTML_HEAD: <style> #table-of-contents h2{background-color:#cba6f7;} </style>
